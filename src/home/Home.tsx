...
export function Home() {
  ...
  return <><Cursor /><Navbar onBook={openBooking} /><main ref={root} className="relative"><div className="pt-28 lg:pt-32"><BookingWidget onBook={openBooking} /></div><Hero onBook={openBooking} /><AboutPreview /><RoomsPreview /><DiningPreview /><Amenities /><Experience /><GalleryPreview /><Testimonials /><LocationPreview /><BookingCTA onBook={openBooking} /><Footer onBook={openBooking} /></main><BookingPanel open={booking} onClose={() => setBooking(false)} /></>;
}